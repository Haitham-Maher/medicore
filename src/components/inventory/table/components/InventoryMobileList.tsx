                                ...
                                >
                                    <div className="flex items-center gap-3 sm:gap-4">
                                        ...
                                        <div className="space-y-0.5 sm:space-y-1">
                                            ...
                                            <div className="flex items-center gap-1 sm:gap-1.5">
                                                ...
                                                )}>{item.stock.toLocaleString('en-US')}</span>
                                                <span className="text-[7px] sm:text-[8px] text-muted-foreground font-medium opacity-50">{item.unit}</span>
                                            </div>
                                        </div>
                                        <div className="space-y-0.5 sm:space-y-1">
                                            <p className="text-[7px] sm:text-[8px] font-medium text-muted-foreground/50 uppercase tracking-wider">تاريخ الانتهاء</p>
                                            <p className="text-[11px] sm:text-[12px] font-bold text-foreground">{item.expiry}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between pt-0.5 sm:pt-1">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="font-bold text-xs sm:text-sm text-primary/80 tracking-tighter">{item.price.toFixed(2)} <span className="text-[8px] font-medium">ر.س</span></span>
                                        </div>
                                        <div className={cn(
