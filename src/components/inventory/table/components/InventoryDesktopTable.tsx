...
export default function InventoryDesktopTable({ data, selectedCategory, search }: InventoryDesktopTableProps) {
    const [dataState, setDataState] = useState<InventoryItem[]>(data);
    ///////////////////////////////////////////////////////////
    useEffect(() => {
        setDataState(data);
    }, [data]);
                                            ...
                                            <TableCell className="text-center pl-6">
                                                <div className="flex justify-between items-center gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-8 h-8 flex items-center justify-center rounded-lg bg-red-500/10 text-red-600 border border-red-500/20 hover:bg-red-500 hover:text-white transition-all cursor-pointer shadow-sm active:scale-95" title="حذف">
                                                        <Trash2 size={14} />
                                                    </button>
                                                </div>
                                            </TableCell>
