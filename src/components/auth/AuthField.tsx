...
export function AuthField({ label, id, type = "text", placeholder, value, onChange, icon: Icon, error }: FieldProps) {
            ...
            <div className="relative flex items-center">
                ...
                {isPassword && (
                    <button type="button" onClick={() => setShow(!show)} tabIndex={-1}
                        className="absolute left-3 text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
