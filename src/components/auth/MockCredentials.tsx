...
const credentials = [
    ...
    {
        email: "sibyl.yost@example.net",
        role: "manager",
        label: "مشرف النقطة (Manager)",
        icon: Activity,
        color: "text-blue-500",
        bg: "bg-blue-500/10",
    },
    {
        email: "denesik.maxie@example.org",
        role: "department_manager",
        label: "رئيس القسم (Dept Manager)",
        icon: UserCircle,
        color: "text-amber-500",
        bg: "bg-amber-500/10",
    },
    {
        email: "zheaney@example.net",
        role: "doctor",
        label: "طبيب (Doctor)",
        icon: User,
