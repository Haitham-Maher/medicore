...
export const roles = [
    ...
    { id: "manager", label: "مشرف النقطة", desc: "إدارة النقطة الطبية", icon: ClipboardList, href: "/manager/dashboard" },
    { id: "department-head", label: "رئيس قسم", desc: "إدارة القسم والأطباء", icon: Shield, href: "/department-head/dashboard" },
