...
export default function MedicalPointHeader({ name, location, rating, status, image, manager, isLoading = false }: MedicalPointHeaderProps) {
    if (isLoading) {
        return (
    ...
    return (
        <div className="relative h-64 md:h-80 rounded-3xl overflow-hidden group">
            ...
            <div className="absolute inset-0">
                <img
                    src={image === null ? "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=1200" : image}
                    alt={name}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div className="space-y-2">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-white">نقطة {name} الطبية</h1>
                </div>
