...
export default function AuthPage() {
    ...
    function handleSuccess(roleId?: string) {
        let freshlySavedRole = localStorage.getItem("user_role") || "";
        freshlySavedRole = freshlySavedRole.toLowerCase();

        // توحيد المسميات بين الفرونت والباك
        if (freshlySavedRole === "department_manager") {
            freshlySavedRole = "department-head";
        } else if (freshlySavedRole === "manager") {
            freshlySavedRole = "manager";
        }
