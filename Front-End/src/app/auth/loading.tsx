        ...
        <div className="flex flex-col lg:flex-row h-screen bg-background overflow-hidden" dir="rtl">
                ...
                <div className="relative flex flex-col justify-between h-full p-10 xl:p-14 z-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="h-10 w-80 bg-emerald-500/20 rounded-2xl" />
                            <div className="h-8 w-64 bg-emerald-500/15 rounded-2xl" />
                        </div>
                        ...
                        <div className="flex gap-8 py-4">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="space-y-2">
                                    <div className="h-6 w-12 bg-emerald-500/20 rounded-lg" />
                                    <div className="h-2 w-8 bg-emerald-500/10 rounded-lg" />
                                </div>
                            ))}
                        </div>

                        {/* Dashboard Card Skeleton */}
                        <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-2xl p-4 max-w-xs space-y-3">
                            <div className="flex justify-between">
                                <div className="h-3 w-20 bg-emerald-500/20 rounded-lg" />
                                <div className="h-2 w-8 bg-emerald-500/20 rounded-lg" />
                            </div>
                            {[1, 2, 3].map(i => (
                                <div key={i} className="flex justify-between items-center py-1">
                                    <div className="h-2 w-16 bg-emerald-500/10 rounded-lg" />
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 relative overflow-hidden">
                <div className="w-full max-w-md space-y-10">
                    ...
                    {/* Footer Text Skeleton (HIPAA/Security) */}
                    <div className="h-3 w-64 bg-muted/20 rounded-lg mx-auto opacity-50" />
                </div>
            </div>
        </div>
    );
