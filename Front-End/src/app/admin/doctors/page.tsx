...
import { Users, ShieldCheck, Shield, Stethoscope, LayoutGrid, TableIcon, Search } from "lucide-react";
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <DoctorDetailsModal
                ...
                onClose={() => {
                    ...
                    // We don't reset selectedPerson immediately to avoid flash during exit animation
                }}
